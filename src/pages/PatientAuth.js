...
const PatientAuth = ({ setAuthStatus }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (credentials.username === 'manishisspecial@gmail.com' && credentials.password === 'love') {
    ...
    <div className="min-h-screen bg-neutral-900">
      ...
      <div className="relative bg-neutral-800">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Patient Sign In</h1>
          <p className="mt-6 text-xl text-neutral-300 max-w-3xl">
            Sign in to access your patient portal and manage your healthcare information.
          </p>
        </div>
      </div>
